        ...
        rm1.setOnClickListener(
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        Intent intent=new Intent (Intent.ACTION_VIEW, Uri.parse("https://www.ajio.com/ethnic-junction-banarasi-silk-floral-pattern-jacquard-saree/p/462468639_maroon#gmf"));
        ...
        rm2.setOnClickListener(
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        Intent intent=new Intent (Intent.ACTION_VIEW, Uri.parse("https://www.myntra.com/Sarees/VAIVIDHYAM/VAIVIDHYAM-Magenta-Floral-Net-Saree/18219594/buy"));
                        startActivity(intent);
                    }
                });
